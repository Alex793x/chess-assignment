...
public final class GameEngine {
    ...
    public static void playChess(Chessboard chessboard) {
        ...
        boolean isWhiteSide = side.equals("W");
    ...
    private static String chooseSide(Scanner scanner) {
        String side;
        while (true) {
            System.out.println("Please choose your side. Type 'W' if you want to play as White, or 'B' if you want to play as Black:");
    ...
    private static boolean playerTurn(Scanner scanner, Chessboard chessboard, boolean isWhiteTurn) {
        ...
        while (!validMove) {
            System.out.println(isWhiteTurn ? "White's turn. Please enter your move in the format example: e7 e5." :
                    "Black's turn. Please enter your move in the format example: e7 e5.");
    ...
    private static void computerTurn(Chessboard chessboard, boolean isWhiteTurn) {
        long timeLimitMillis = 15 * 1000;
        System.out.println("-------------------------------------------");
        System.out.println("The computer is thinking about its move. Hold up...");
        Engine engine = new Engine(16);
        Move bestMove = engine.findBestMove(chessboard.getBoard(), isWhiteTurn, timeLimitMillis);
        engine.applyMove(bestMove, chessboard.getBoard());
        System.out.println("The computer has chosen to move: " + bestMove);
