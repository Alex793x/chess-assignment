...
import org.kea.chessbackend.chess_test_engine.board.enums.GamePhase;
...
import org.kea.chessbackend.chess_test_engine.engine.move_validation.service.MoveValidator;
...
public final class Board {
    ...
    private void initializeBoard() {
        // White pieces
        bitboard.placePieceOnSquare(56, PieceType.ROOK, PieceColor.WHITE);   // A1
        bitboard.placePieceOnSquare(57, PieceType.KNIGHT, PieceColor.WHITE); // B1
        bitboard.placePieceOnSquare(58, PieceType.BISHOP, PieceColor.WHITE); // C1
        bitboard.placePieceOnSquare(59, PieceType.QUEEN, PieceColor.WHITE);  // D1
        bitboard.placePieceOnSquare(60, PieceType.KING, PieceColor.WHITE);   // E1
        bitboard.placePieceOnSquare(61, PieceType.BISHOP, PieceColor.WHITE); // F1
        bitboard.placePieceOnSquare(62, PieceType.KNIGHT, PieceColor.WHITE); // G1
        bitboard.placePieceOnSquare(63, PieceType.ROOK, PieceColor.WHITE);   // H1
        for (int i = 48; i <= 55; i++) {
            bitboard.placePieceOnSquare(i, PieceType.PAWN, PieceColor.BLACK); // A2 to H2
        }
        ...
        bitboard.placePieceOnSquare(0, PieceType.ROOK, PieceColor.BLACK);    // H8
        bitboard.placePieceOnSquare(1, PieceType.KNIGHT, PieceColor.BLACK);  // G8
        bitboard.placePieceOnSquare(2, PieceType.BISHOP, PieceColor.BLACK);  // F8
        bitboard.placePieceOnSquare(3, PieceType.QUEEN, PieceColor.BLACK);   // E8
        bitboard.placePieceOnSquare(4, PieceType.KING, PieceColor.BLACK);    // D8
        bitboard.placePieceOnSquare(5, PieceType.BISHOP, PieceColor.BLACK);  // C8
        bitboard.placePieceOnSquare(6, PieceType.KNIGHT, PieceColor.BLACK);  // B8
        bitboard.placePieceOnSquare(7, PieceType.ROOK, PieceColor.BLACK);    // A8
    }
